#!/bin/bash
# p104 build: incremental Image with p104 (DCS 0x0A read probe) + repack boot-v27n37
exec > /mnt/d/work/code-work/project/tb371fc-kernel/logs/p104-build.log 2>&1
...
cp arch/arm64/boot/Image $BASE/out/Image-v27n37
python3 $BASE/tools/repack_boot.py $BASE/apatch_patched_11266_0.13.5_clte.img \
    $BASE/out/Image-v27n37 $BASE/out/boot-v27n37-q706.img $BASE/out/dtbs/tail-new.bin
echo "repack exit=$?"
md5sum $BASE/out/boot-v27n37-q706.img
