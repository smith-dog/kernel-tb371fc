#!/bin/bash
# p211-build-n94.sh — v27n94 = n91 + p206 pen b3 00 gate-open (FACT-026 mandatory:
...
LOG=$BASE/logs/p211-build.log
exec > "$LOG" 2>&1
echo "=== P211 BUILD START $(date) ==="
...
cp arch/arm64/boot/Image $BASE/out/Image-v27n94
...
python3 tools/repack_boot.py firmware/apatch_patched_11266_0.13.5_clte.img     out/Image-v27n94 out/boot-v27n94-pure-q706.img out/dtbs/tail-new.bin 2>&1 | tail -2
python3 tools/repack_boot.py out/kernelsu_patched_20260924_084550.img     out/Image-v27n94 out/boot-v27n94-kspatched-flash.img out/dtbs/tail-new.bin 2>&1 | tail -2
echo "=== banner ==="
strings out/Image-v27n94 | grep -m1 "Linux version"
echo "=== md5 ==="
md5sum out/Image-v27n94 out/boot-v27n94-pure-q706.img out/boot-v27n94-kspatched-flash.img
echo "=== P211 BUILD DONE $(date) ==="
