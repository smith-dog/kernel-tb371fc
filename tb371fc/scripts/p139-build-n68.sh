#!/bin/bash
# p139 build: v27n68 = p133+p134 gesture + p137(p+header) pstore dcache flush
...
exec > /mnt/d/work/code-work/project/tb371fc-kernel/logs/p139-build.log 2>&1
echo "=== P139 BUILD START $(date) ==="
...
cp arch/arm64/boot/Image $BASE/out/Image-v27n68
...
cd $BASE
python3 tools/repack_boot.py apatch_patched_11266_0.13.5_clte.img out/Image-v27n68 out/boot-v27n68-patched-q706.img out/dtbs/tail-new.bin out/ramdisk-114142.img "ramoops.mem_address=0x27e000000 ramoops.mem_size=0x200000 ramoops.console_size=0x180000 ramoops.record_size=0x20000" || { echo REPACK_FAILED; exit 1; }
echo "=== artifacts ==="
ls -la out/Image-v27n68 out/boot-v27n68-patched-q706.img
echo "=== md5 ==="
md5sum out/Image-v27n68 out/boot-v27n68-patched-q706.img
echo "=== P139 BUILD DONE $(date) ==="
