#!/bin/bash
# p128 build: charge_disable attr 0666 -> v27n57 (#73)
...
cp arch/arm64/boot/Image $BASE/out/Image-v27n57
cd $BASE
python3 tools/repack_boot.py apatch_patched_11266_0.13.5_clte.img out/Image-v27n57 out/boot-v27n57-q706.img out/dtbs/tail-new.bin
echo "=== md5 ==="
md5sum out/boot-v27n57-q706.img
